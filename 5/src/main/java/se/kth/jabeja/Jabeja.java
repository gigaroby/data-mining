...
public class Jabeja {
    ...
    private double timesAlpha(int x) {
        return Math.pow(x, config.getAlpha());
    }
    ...
    public Node findPartner(int nodeId, Integer[] nodes) {
        ...
        for (int qId : nodes) {
            ...
            double old = timesAlpha(dpp) + timesAlpha(dqq);

            int dpq = getDegree(nodep, nodeq.getColor());
            int dqp = getDegree(nodeq, nodep.getColor());
            double new_ = timesAlpha(dpq) + timesAlpha(dqp);
