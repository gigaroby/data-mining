...
public class Config {
    ...
    // restartAfter restarts the simulated anealing after a set number of cuts
    ...
    public Integer getRestartAfter() {
        return restartAfter;
    }

    public Config setRestartAfter(Integer restartAfter) {
    ...
    public Config setAcceptanceFunction(String acceptanceFunction) {
        switch(acceptanceFunction){
            case "SIMPLE":
                this.acceptanceFunction = AcceptanceFunction.SIMPLE;
                break;
            case "EXPONENTIAL":
                this.acceptanceFunction = AcceptanceFunction.EXPONENTIAL;
                break;
            default:
                throw new IllegalArgumentException("invalid acceptance function " + acceptanceFunction);
        }
        return this;
    }
